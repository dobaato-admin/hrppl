...
function OvertimeRatesAdmin() {
  ...
  const [form, setForm] = useState({
    code: "",
    name: "",
    applies_to: "overtime" as "overtime" | "penalty",
    rate_multiplier: 1.5,
    description: "",
    ...
    <AppShell>
      <main className="min-h-screen bg-background">
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Country-level multipliers used by payroll
              </p>
            </div>
            <Link to="/dashboard">
        ...
        <section className="mx-auto grid max-w-6xl gap-6 px-6 py-10">
              ...
              <form onSubmit={addRate} className="grid gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v: "overtime" | "penalty") =>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Rates ({rows.length})</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {rows.length === 0 ? (
                    ...
                    rows.map((r) => (
                      <TableRow key={r.id}>
                        <TableCell>
                          <Badge variant={r.applies_to === "overtime" ? "default" : "secondary"}>
                            {r.applies_to}
                          </Badge>
                        </TableCell>
                        ...
                        <TableCell className="font-mono">
                          {Number(r.rate_multiplier).toFixed(2)}
                        </TableCell>
