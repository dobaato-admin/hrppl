        ...
        <header className="border-b border-border bg-card">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              <Link to="/admin/holiday-calendar">
                <Button size="sm">Annual calendar</Button>
              </Link>
              <Link to="/dashboard">
        ...
        <section className="mx-auto grid max-w-6xl gap-6 px-6 py-10">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Holidays are visible to everyone in tenants for the selected country.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
                onSubmit={addHoliday}
                className="grid gap-4 md:grid-cols-[200px_1fr_200px_auto] md:items-end"
              >
                ...
                <Button type="submit" disabled={busy || !country}>
                  Add
                </Button>
                    ...
                    {list.map((r) => (
                      <TableRow key={r.id}>
                        ...
                        <TableCell>
                          <Switch
                            checked={r.is_paid}
                            onCheckedChange={(v) => patch(r.id, { is_paid: v })}
                          />
                        </TableCell>
                        <TableCell>
                          <Switch
                            checked={r.is_recurring}
                            onCheckedChange={(v) => patch(r.id, { is_recurring: v })}
                          />
                        </TableCell>
                        <TableCell>
                          <Input
          ...
          {rows.length === 0 && country && (
            <Card>
              <CardContent className="py-10 text-center text-sm text-muted-foreground">
                No holidays yet for this country.
              </CardContent>
            </Card>
          )}
        </section>
