...
import {
  logTemplateAuditEvent,
  listTemplateAuditLog,
  generateReviewInstances,
...
export const Route = createFileRoute("/admin/review-templates")({
  ...
  component: () => (
    <AdminGate feature="org.reviewTemplates">
...
function newComp(type: CompetencyType = "rating"): Competency {
  return {
    ...
    required: true,
    evidenceEnabled:
      type === "number" || type === "percentage" || type === "currency" || type === "yes_no",
...
function ReviewTemplatesAdmin() {
  ...
  async function confirmAssign() {
    ...
    if (assignScope === "department") {
      ...
      if (!employeeIds.length) {
        toast.error("That department has no active employees");
        return;
      }
  ...
  useEffect(() => {
    load(); /* AdminGate guarantees access above */
  }, []);
    ...
    <AppShell>
      <main className="min-h-screen bg-background">
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Pick an industry, start from a standard preset, and customize for your org.
              </p>
            </div>
            <Link to="/org">
        ...
        <section className="mx-auto max-w-6xl px-6 py-8 space-y-6">
            ...
            <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <CardDescription>
                  ...
                  a cycle in{" "}
                  <Link to="/org/performance" className="underline underline-offset-2">
                    Performance cycles
                  </Link>
                  .
                </CardDescription>
                    ...
                    <div className="space-y-3 max-h-[75vh] overflow-auto pr-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div>
                          ...
                          <Select
                            value={form.kind}
                            onValueChange={(v) => setForm({ ...form, kind: v as TemplateKind })}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div>
                          ...
                          <Input
                            ...
                            max={9}
                            value={form.scaleMin}
                            onChange={(e) => setForm({ ...form, scaleMin: Number(e.target.value) })}
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            max={10}
                            value={form.scaleMax}
                            onChange={(e) => setForm({ ...form, scaleMax: Number(e.target.value) })}
                          />
                        </div>
                        <div>
                          <Label>Scale labels (comma-separated)</Label>
                          <Input
                            value={form.scaleLabels}
                            onChange={(e) => setForm({ ...form, scaleLabels: e.target.value })}
                            ...
                            <div key={c.id} className="rounded border p-3 space-y-2 bg-muted/30">
                              <div className="grid grid-cols-12 gap-2">
                                ...
                                <Select
                                  value={c.type}
                                  onValueChange={(v) =>
                                    updateComp(i, { type: v as CompetencyType })
                                  }
                                >
                                ...
                                <label className="col-span-1 flex items-center gap-1 text-xs">
                                  <Checkbox
                                    checked={c.required}
                                    onCheckedChange={(v) => updateComp(i, { required: !!v })}
                                  />
                                  Req
                                </label>
                                <Button
                              ...
                              <Input
                                placeholder="Optional description / definition"
                                value={c.description ?? ""}
                              ...
                              {(c.type === "number" ||
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                  ...
                                  <Input
                                    placeholder="Target"
                                    value={c.target?.toString() ?? ""}
                                    onChange={(e) =>
                                      updateComp(i, { target: e.target.value || undefined })
                                    }
                                  />
                                  <Input
                                    placeholder="Unit (e.g. %, AUD, days)"
                                    value={c.unit ?? ""}
                                    onChange={(e) =>
                                      updateComp(i, { unit: e.target.value || undefined })
                                    }
                                  />
                                </div>
                              )}
                              ...
                              {c.type === "yes_no" && (
                                <div className="grid grid-cols-2 gap-2">
                                  <Input
                                    placeholder="Yes label (default: Met)"
                                    value={c.yesLabel ?? ""}
                                    onChange={(e) =>
                                      updateComp(i, { yesLabel: e.target.value || undefined })
                                    }
                                  />
                                  <Input
                                    placeholder="No label (default: Not met)"
                                    value={c.noLabel ?? ""}
                                    onChange={(e) =>
                                      updateComp(i, { noLabel: e.target.value || undefined })
                                    }
                                  />
                                </div>
                              )}
                              ...
                              <div className="space-y-2 rounded border bg-background p-2 text-xs">
                                <div className="flex flex-wrap items-center gap-3">
                                  <label className="flex items-center gap-1">
                                    <Checkbox
                                      checked={!!c.evidenceEnabled}
                                      onCheckedChange={(v) =>
                                        updateComp(i, { evidenceEnabled: !!v })
                                      }
                                    />
                                  ...
                                  {c.evidenceEnabled && (
                                    <>
                                      ...
                                      {(["document", "url", "social", "screenshot"] as const).map(
                                        (t) => (
                                          <label key={t} className="flex items-center gap-1">
                                            <Checkbox
                                              ...
                                              onCheckedChange={(v) => {
                                                ...
                                                updateComp(i, {
                                                  evidenceTypes: Array.from(cur) as EvidenceType[],
                                                });
                                              }}
                                            />
                                            {t}
                                ...
                                {c.evidenceEnabled && (
                                  <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    <Input
                                      ...
                                      onChange={(e) =>
                                        updateComp(i, {
                                          minEvidenceCount: e.target.value
                                      ...
                                      <label key={t} className="flex items-center gap-1">
                                        <Checkbox
                                          ...
                                          onCheckedChange={(v) => {
                                            ...
                                            updateComp(i, {
                                              requiredEvidenceTypes: Array.from(
                                                cur,
                                              ) as EvidenceType[],
                                            });
                                          }}
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-xs items-end">
                                ...
                                {c.schedule && (
                                  <div className="md:col-span-2">
                                    <Label className="text-xs">
                                      Periods (comma-separated, e.g. Q1,Q3 or Jan,Apr,Jul,Oct)
                                    </Label>
                                    <Input
                                      className="h-8"
                                      value={(c.schedule.periods ?? []).join(",")}
                                      onChange={(e) =>
                                        updateComp(i, {
                                          schedule: {
                                            ...(c.schedule as ReviewSchedule),
                                ...
                                <div className="md:col-span-3">
                                  <Input
                                    className="h-7"
                                    placeholder="Free-text period hint (legacy)"
                                    value={c.reviewPeriod ?? ""}
                                    onChange={(e) =>
                                      updateComp(i, { reviewPeriod: e.target.value || undefined })
                                    }
                                  />
                                </div>
                              </div>
                      ...
                      {issues.length > 0 && (
                        <div className="rounded border border-destructive/50 bg-destructive/5 p-2 text-xs text-destructive">
                          <div className="font-medium mb-1">
                            Cannot save — {issues.length} issue(s):
                          </div>
                        ...
                        <div className="border-t pt-3 space-y-2">
                          <div className="flex items-center gap-2">
                            <Checkbox
                              ...
                              onCheckedChange={(v) => setForm({ ...form, bumpVersion: !!v })}
                            />
                            <Label>Save as a new version (preserve history)</Label>
                          </div>
                          <div>
                    ...
                    <DialogFooter className="gap-2">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setIssues(next);
                          toast[next.length ? "error" : "success"](
                            next.length ? `${next.length} issue(s) — see panel` : "Looks good",
                          );
                        }}
                      >
                        Validate
                ...
                <TableBody>
                  {filteredTemplates.map((t) => (
                    <TableRow key={t.id}>
                      ...
                      <TableCell>
                        <Badge variant="secondary">{(t.kind ?? "competency").toUpperCase()}</Badge>
                      </TableCell>
                      ...
                      <TableCell className="text-right space-x-1">
                        ...
                        <Button size="sm" variant="outline" onClick={() => exportTemplate(t)}>
                          Export
                        </Button>
                  ...
                  {filteredTemplates.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={6} className="text-center text-muted-foreground">
                        No templates match. Create one or load a preset from the “New template”
                        dialog.
                      </TableCell>
                    </TableRow>
                  )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Industry-aware presets. Open “New template”, pick an industry, then choose a preset
                to start.
              </CardDescription>
            </CardHeader>
            <CardContent>
                          ...
                          <li key={p.key} className="flex items-center justify-between gap-2">
                            ...
                            <div className="flex gap-1">
                              <Button
                                ...
                                variant="ghost"
                                onClick={() =>
                                  setPreviewPresetKey(previewPresetKey === p.key ? "none" : p.key)
                                }
                              >
                              ...
                              <Button
                                ...
                                variant="ghost"
                                onClick={() => {
                                  setForm((f) => ({ ...f, industry: p.industry }));
                                  setOpen(true);
        ...
        <Dialog open={auditOpen} onOpenChange={setAuditOpen}>
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              <DialogTitle>Template export / import audit log</DialogTitle>
            </DialogHeader>
                  ...
                  <TableBody>
                    {auditEntries.map((e) => (
                      <TableRow key={e.id}>
                        ...
                        <TableCell>
                          <Badge variant={e.action === "export" ? "secondary" : "default"}>
                            {e.action}
                          </Badge>
                        </TableCell>
        ...
        <Dialog open={assignOpen} onOpenChange={setAssignOpen}>
          <DialogContent className="max-w-lg">
            ...
            {assignLoading ? (
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={assignScope}
                    onValueChange={(v) => setAssignScope(v as typeof assignScope)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="all">
                        Whole tenant ({assignEmployees.length} active employees)
                      </SelectItem>
                ...
                {assignScope === "department" && (
                  <div className="space-y-2">
                      ...
                      <SelectContent>
                        {assignDepartments.map((d) => (
                          <SelectItem key={d.id} value={d.id}>
                            {d.name} (
                            {assignEmployees.filter((e) => e.department_id === d.id).length})
                          </SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                    {assignDepartments.length === 0 && (
                      <p className="text-xs text-muted-foreground">
                        No departments configured for this tenant.
                      </p>
                    )}
                  </div>
                )}
            ...
            <DialogFooter>
              ...
              <Button onClick={confirmAssign} disabled={assignLoading || busy}>
                Assign
              </Button>
            </DialogFooter>
          </DialogContent>
