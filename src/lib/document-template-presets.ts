/**
 * HRPPL-recommended starter library for org_admin document templates.
 * Org admins can instantiate any preset as a draft for their tenant, then
 * customize, publish, and version like any other template.
 */
...
export function getPresetByKey(key: string): DocumentTemplatePreset | undefined {
