...
import { m as Route$2m, a as useServerFn, C as Card, e as CardContent, b as CardHeader, c as CardTitle, d as CardDescription, f as Badge, B as Button } from "./router-CLxirH5A.mjs";
...
import { b as listJobs, a as listProjects, f as upsertJob } from "./practice.functions-DOjbj3P6.mjs";
...
function JobsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { title: "Jobs", subtitle: project ? "Filtered to project" : "All jobs across projects", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-6xl space-y-4 p-4 md:p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Jobs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JobDialog, { onSaved: () => qc.invalidateQueries({
        queryKey: ["jobs"]
      }), defaultProject: project })
    ] }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Loading…" }) : (data?.jobs ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6 text-sm text-muted-foreground", children: "No jobs yet." }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: data?.jobs.map((j) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: j.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
            j.projects?.clients?.name,
            " · ",
            j.projects?.name
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: STATUS_TONE[j.status] ?? "", children: j.status.replace(/_/g, " ") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: j.priority })
        ] })
      ] }) }),
      (j.due_date || j.estimated_hours) && /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "text-sm text-muted-foreground", children: [
        j.due_date && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "Due ",
          j.due_date,
          " · "
        ] }),
        j.estimated_hours && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          j.estimated_hours,
          "h estimated"
        ] })
      ] })
...
function JobDialog({
  ...
  const [draftId, setDraftId] = reactExports.useState(newDraftId);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: handleOpenChange, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { children: "New job" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "New job" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Project" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: form.project_id, onValueChange: (v) => setForm({
            ...form,
            project_id: v
          }), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Pick project" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: (pd?.projects ?? []).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: p.id, children: [
              p.clients?.name,
              " — ",
              p.name
            ] }, p.id)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: form.estimated_hours ?? "", onChange: (e) => setForm({
              ...form,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: submit, disabled: saving || !form.project_id || !form.name, children: saving ? "Saving…" : "Save" })
      ] })
    ] })
  ] });
}
