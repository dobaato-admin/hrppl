...
import { e as useNavigate, d as useRouterState, O as Outlet, L as Link } from "../_libs/tanstack__react-router.mjs";
import { u as useAuth, C as Card, b as CardHeader, c as CardTitle, d as CardDescription, e as CardContent, B as Button } from "./router-CLxirH5A.mjs";
import { A as AppShell } from "./AppShell-fbDALlr7.mjs";
import { i as isOrgMember } from "./rbac-BWg_Nf1T.mjs";
...
function OrgLayout() {
  ...
  if (rolesLoaded && !canAccess && isOrgRoot) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { title: "Organization", subtitle: "Set up your workspace", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-3xl p-4 md:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Create organization" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Redirecting you to the setup wizard…" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/org/setup", children: "Continue to setup" }) }) })
    ] }) }) });
  }
  if (isSetupWizard) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
