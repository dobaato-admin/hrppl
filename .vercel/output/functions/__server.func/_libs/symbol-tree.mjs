var SymbolTreeNode_1;
var hasRequiredSymbolTreeNode;
function requireSymbolTreeNode() {
  if (hasRequiredSymbolTreeNode) return SymbolTreeNode_1;
  hasRequiredSymbolTreeNode = 1;
  SymbolTreeNode_1 = class SymbolTreeNode {
    constructor() {
      this.parent = null;
  ...
  return SymbolTreeNode_1;
}
var TreePosition;
var hasRequiredTreePosition;
function requireTreePosition() {
  if (hasRequiredTreePosition) return TreePosition;
  hasRequiredTreePosition = 1;
  TreePosition = Object.freeze({
...
var TreeIterator_1;
var hasRequiredTreeIterator;
function requireTreeIterator() {
  if (hasRequiredTreeIterator) return TreeIterator_1;
  hasRequiredTreeIterator = 1;
  const TREE = /* @__PURE__ */ Symbol();
  const ROOT = /* @__PURE__ */ Symbol();
  const NEXT = /* @__PURE__ */ Symbol();
  const ITERATE_FUNC = /* @__PURE__ */ Symbol();
  class TreeIterator {
  ...
  TreeIterator_1 = TreeIterator;
  return TreeIterator_1;
}
var SymbolTree_1;
var hasRequiredSymbolTree;
function requireSymbolTree() {
  if (hasRequiredSymbolTree) return SymbolTree_1;
  hasRequiredSymbolTree = 1;
  const SymbolTreeNode = requireSymbolTreeNode();
  const TreePosition2 = requireTreePosition();
  const TreeIterator = requireTreeIterator();
  function returnTrue() {
    return true;
  }
  ...
  class SymbolTree {
    ...
    compareTreePosition(left, right) {
      ...
      const leftAncestors = [];
      {
        ...
        while (leftAncestor) {
          if (leftAncestor === right) {
            return TreePosition2.CONTAINS | TreePosition2.PRECEDING;
          }
      ...
      const rightAncestors = [];
      {
        ...
        while (rightAncestor) {
          if (rightAncestor === left) {
            return TreePosition2.CONTAINED_BY | TreePosition2.FOLLOWING;
          }
      ...
      if (!root || root !== reverseArrayIndex(rightAncestors, 0)) {
        return TreePosition2.DISCONNECTED;
      }
      ...
      return rightIndex < leftIndex ? TreePosition2.PRECEDING : TreePosition2.FOLLOWING;
    }
    /**
  ...
  SymbolTree_1 = SymbolTree;
  SymbolTree.TreePosition = TreePosition2;
  return SymbolTree_1;
}
export {
  requireSymbolTree as r
};
