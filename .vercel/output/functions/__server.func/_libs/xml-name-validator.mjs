...
var hasRequiredXmlNameValidator;
function requireXmlNameValidator() {
  if (hasRequiredXmlNameValidator) return xmlNameValidator;
  hasRequiredXmlNameValidator = 1;
  xmlNameValidator.name = (potentialName) => {
  ...
  xmlNameValidator.qname = (potentialQname) => {
  ...
  return xmlNameValidator;
}
export {
  requireXmlNameValidator as r
};
