...
let EntityDecoder$1 = class EntityDecoder {
  ...
  state = EntityDecoderState$1.EntityStart;
  ...
  decodeMode = DecodingMode$1.Strict;
...
function getDecoder(decodeTree) {
  let ret = "";
  const decoder = new EntityDecoder2(decodeTree, (str) => ret += fromCodePoint(str));
...
export {
  BinTrieFlags as B,
  DecodingMode$1 as D,
  EntityDecoder$1 as E,
  escapeAttribute$1 as a,
  htmlDecodeTree as b,
  encodeXML as c,
  ...
  fromCodePoint as f,
  escapeText as g,
  htmlDecodeTree$1 as h,
  escapeAttribute as i,
