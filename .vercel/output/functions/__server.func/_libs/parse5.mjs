...
import { E as EntityDecoder, h as htmlDecodeTree, D as DecodingMode, e as escapeText, a as escapeAttribute } from "./entities.mjs";
...
const token = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  get TokenType() {
    return TokenType;
  },
...
const foreignContent = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
class Parser {
  ...
  shouldProcessStartTagTokenInForeignContent(token2) {
    ...
    return (
      ...
      // integration point.
      (token2.tagID === TAG_ID.MGLYPH || token2.tagID === TAG_ID.MALIGNMARK) && currentTagId !== void 0 && !this._isIntegrationPoint(currentTagId, current, NS.HTML)
    );
  }
  /** @protected */
